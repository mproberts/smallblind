...
function State(fsm, name) {
	...
	this.name = name;
	this.transitions = {};
	this.transitionAny = null;
	this.transitionAuto = null;
...
FSM.prototype.tryAdvance = function(transition) {
	...
	if (typeof(this.currentState) !== 'undefined') {
		...
		if (typeof(destination) !== 'undefined') {
			...
			return true;
		} else if (this.currentState.transitionAny) {
			this._updateState(this.currentState.transitionAny, args);
...
FSM.prototype._updateState = function(state, args) {
	...
	if (state.transitionAuto && state.transitionAuto !== state) {
		this._updateState(state.transitionAuto, args);
	}
};
